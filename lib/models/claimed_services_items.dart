...
//
//     final claimedServicesItems = claimedServicesItemsFromJson(jsonString);

import 'dart:convert';

ClaimedServicesItems claimedServicesItemsFromJson(String str) => ClaimedServicesItems.fromJson(json.decode(str));

String claimedServicesItemsToJson(ClaimedServicesItems data) => json.encode(data.toJson());

class ClaimedServicesItems {
  ClaimedServicesItems({
    this.data,
  });

  Data data;

  factory ClaimedServicesItems.fromJson(Map<String, dynamic> json) => ClaimedServicesItems(
